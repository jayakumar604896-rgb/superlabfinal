    ...
    <div class="col-md-10">
        <form action="{{ route('admin.packages.update', $package->id) }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('badge') is-invalid @enderror" id="badge" name="badge" value="{{ old('badge', $package->badge) }}" placeholder="e.g. MOST BOOKED">
                            @error('badge')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('tests_included_count') is-invalid @enderror" id="tests_included_count" name="tests_included_count" value="{{ old('tests_included_count', $package->tests_included_count) }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('discount_percentage') is-invalid @enderror" id="discount_percentage" name="discount_percentage" value="{{ old('discount_percentage', $package->discount_percentage) }}" placeholder="e.g. 49">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('original_price') is-invalid @enderror" id="original_price" name="original_price" value="{{ old('original_price', $package->original_price) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('offer_price') is-invalid @enderror" id="offer_price" name="offer_price" value="{{ old('offer_price', $package->offer_price) }}">
                            @error('offer_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('fasting_condition') is-invalid @enderror" id="fasting_condition" name="fasting_condition" value="{{ old('fasting_condition', $package->fasting_condition) }}" placeholder="e.g. 10-12 Hours Fasting Recommended">
                ...
                <div class="card-body">
                    <div id="componentsWrapper">
                        @if(!empty($package->test_components) && is_array($package->test_components))
                            @foreach($package->test_components as $comp)
                                <div class="row g-2 mb-2 align-items-center component-item">
                                    <div class="col-10">
                                        <input type="text" name="test_components[]" class="form-control" value="{{ $comp }}" placeholder="e.g. Hemogram">
                                    </div>
                        ...
                        @else
                            <div class="row g-2 mb-2 align-items-center component-item">
                                <div class="col-10">
                                    <input type="text" name="test_components[]" class="form-control" placeholder="e.g. Hemogram">
                                </div>
                                <div class="col-2 text-end">
                                    <button type="button" class="btn btn-outline-danger remove-component w-100"><i class="fa-solid fa-trash-can"></i> Remove</button>
                                </div>
                            ...
                            @foreach($package->faqs as $index => $faq)
                                <div class="border p-3 rounded mb-3 faq-item position-relative">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="faqs[{{ $index }}][question]" class="form-control" value="{{ $faq['question'] ?? '' }}" placeholder="Question">
                                    </div>
                                    <div class="mb-0">
            ...
            <div class="text-end mb-5">
                ...
                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-save"></i> Update Package</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    // Dynamic FAQs
    let faqIndex = {{ !empty($package->faqs) ? count($package->faqs) : 1 }};
