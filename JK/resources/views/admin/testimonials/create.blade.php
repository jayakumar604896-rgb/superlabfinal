    ...
    <div class="col-md-8">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="m-0 fw-bold">Testimonial Details</h5>
                ...
                <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('client_designation') is-invalid @enderror" id="client_designation" name="client_designation" value="{{ old('client_designation') }}" placeholder="e.g. Patient / Fitness Coach">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('message') is-invalid @enderror" id="message" name="message" rows="4" placeholder="Feedback or review details...">{{ old('message') }}</textarea>
                        @error('message')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary"><i class="fa-solid fa-save"></i> Save Testimonial</button>
                    </div>
                </form>
            </div>
        </div>
